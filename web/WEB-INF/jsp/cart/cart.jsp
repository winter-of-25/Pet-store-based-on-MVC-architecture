...
<script>
    ...
    // AJAX更新购物车函数
    function updateCartWithAjax(event) {
        ...
        var updateButton = document.querySelector('input[type="submit"][value="Update Cart"]');
        var originalText = updateButton.value;
        // updateButton.value = '更新中...';
        ...
        fetch('updateCart', {
            ...
            .finally(() => {
                updateButton.value = originalText;
...
<div class="page-wrap">
    ...
    <div id="Catalog">
        <div id="Cart">
            ...
            <form action="updateCart" method="post" onsubmit="updateCartWithAjax(event)">
                <table>
                    <tr>
                        <th><b>Item ID</b></th>
